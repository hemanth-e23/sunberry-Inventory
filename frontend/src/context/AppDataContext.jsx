...
export const AppDataProvider = ({ children }) => {
  ...
  const value = useMemo(() => ({
    ...
    packageSizes: foundation.packageSizes,
    updatePackageSize: foundation.updatePackageSize,
    palletTypes: foundation.palletTypes,
    shipToLocations: foundation.shipToLocations,
    carriers: foundation.carriers,
    createScheduledOrder: foundation.createScheduledOrder,
